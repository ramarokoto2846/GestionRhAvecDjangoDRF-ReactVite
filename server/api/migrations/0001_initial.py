...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Absence',
            fields=[
                ('id_absence', models.CharField(max_length=10, primary_key=True, serialize=False)),
                ...
                ('employe', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='absences', to='api.employe')),
            ],
        ),
        migrations.CreateModel(
            name='Evenement',
        ...
        migrations.CreateModel(
            name='StatistiquesDepartement',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('mois', models.DateField()),
                ('taux_absence_moyen', models.FloatField(default=0)),
                ('heures_travail_moyennes', models.DurationField(blank=True, null=True)),
                ('total_employes', models.IntegerField(default=0)),
                ('employes_actifs', models.IntegerField(default=0)),
                ('total_heures_travail', models.DurationField(blank=True, null=True)),
                ('pointages_total', models.IntegerField(default=0)),
                ('retard_moyen', models.DurationField(blank=True, null=True)),
                ('total_absences', models.IntegerField(default=0)),
                ('absences_justifiees', models.IntegerField(default=0)),
                ...
                ('date_calcul', models.DateTimeField(auto_now=True)),
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='created_statistiques_departement', to=settings.AUTH_USER_MODEL)),
                ('departement', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='statistiques', to='api.departement')),
            ],
            options={
                'verbose_name': 'Statistiques département',
                'verbose_name_plural': 'Statistiques départements',
                'indexes': [models.Index(fields=['departement', 'mois'], name='api_statist_departe_21de0e_idx')],
